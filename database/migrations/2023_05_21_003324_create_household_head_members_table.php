...
class CreateHouseholdHeadMembersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('household_head_members', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('household_head_members');
    }
}